...
Demo of a couple target URLs for iBeacon bluetooth devices. Live at:

http://libraries.cca.edu/beacon/macky.html
http://libraries.cca.edu/beacon/meyer.html

## LICENSE

[Apache v2](https://www.apache.org/licenses/LICENSE-2.0)

I used `yo mobile` (Yeoman's mobile generator) to scaffold this app out, including `gulp` tasks. Web starter readme below.
